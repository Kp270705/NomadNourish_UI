    ...
    <div class="p-4 py-5 rounded-lg dark:border-gray-700 bg-white/70 dark:bg-gray-800/70 backdrop-blur">
      ...
      {#if $userType === 'user'}
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Card class="flex flex-col items-center justify-between rounded-xl bg-yellow-100 dark:bg-yellow-700 p-6 shadow-lg hover:shadow-xl transition-shadow justify-self-center ">
            ...
            <div class="flex flex-col items-center pb-6 text-center">
              ...
              <h5 class="mb-2 mt-4 text-xl font-bold text-gray-900 dark:text-white">
                {restaurant.name}
              </h5>
            ...
            <div class="mt-4 flex flex-col sm:flex-row gap-4 w-full justify-center">
              <a use:link href={`/restaurant/${restaurant.id}/cuisines`} class="w-full sm:w-auto bg-red-500 hover:bg-red-600 text-white text-center py-2 px-4 rounded-lg">
                See cuisine
              </a>
              <Button color="light" class="w-full sm:w-auto dark:text-white">Contact</Button>
            </div>
